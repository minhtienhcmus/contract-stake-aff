 ...
 */
contract CoinPNC is Context, Ownable, Pausable, IERC20 {
 ...
 * @dev Issues `amount` tokens to the designated `address`.
 *
 * Can only be called by an allowed minter.
 */
function mintFromContract(address account, uint256 amount) public {
    require(_minters[_msgSender()], "CoinPNC: caller is not allowed to mint");
    _mint(account, amount);
}
  ...
  function unfreeze() public onlyOwner {
    ...
    /**
     * @dev Adds an address to the list of allowed minters.
     * Can only be called by the contract owner.
     */
    function addContractMinter(address account) public onlyOwner {
        _minters[account] = true;
    }

    /**
     * @dev Removes an address from the list of allowed minters.
     * Can only be called by the contract owner.
     */
    function removeContractMinter(address account) public onlyOwner {
